...
public interface TrapBubble {
  ...
  Animation ANIMATION_IDLE = new Animation("idle", FRAME_ANIMATION_SPEED,
          new RenderSprite(new Point2i(0, 0), Ressources.SpriteSheet_BubbleCapture),
          new RenderSprite(new Point2i(1, 0), Ressources.SpriteSheet_BubbleCapture),
          new RenderSprite(new Point2i(2, 0), Ressources.SpriteSheet_BubbleCapture)
  );
}
